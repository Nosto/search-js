...
describe("usePagination", () => {
  ...
  function mockUsePegination(from: number, total: number, width = 10) {
    store.updateState({
      query: {
        products: {
          from
