...
const preactPackages = ["autocomplete", "category", "common", "events", "hooks", "inject", "legacy", "serp", "utils"]
...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@preact/utils": resolve(import.meta.dirname, "packages/preact/utils/src"),
